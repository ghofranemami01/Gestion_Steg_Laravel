...
<head>
    ...
    <title>Modifier l'Abonné - {{ $abonne->nom }} {{ $abonne->prenom }} - STEG</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <h1><i class="fas fa-user-edit me-2"></i>Modifier l'Abonné</h1>
                <p class="text-muted">Modification des informations de {{ $abonne->nom }} {{ $abonne->prenom }}</p>
            </div>
            <div class="col-md-4 text-end">
                <div class="btn-group" role="group">
                    <a href="{{ route('abonnes.show', $abonne->id) }}" class="btn btn-info btn-lg">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="info-badge">{{ $abonne->reference }}</div>
                            </div>
                            <div class="col-md-3">
                                <small class="text-muted">CIN</small>
                                <div class="info-badge">{{ $abonne->num_cin }}</div>
                            </div>
                            <div class="col-md-3">
                                <small class="text-muted">Date d'Abonnement</small>
                                <div class="info-badge">{{ \Carbon\Carbon::parse($abonne->date_abonnement)->format('d/m/Y') }}</div>
                            </div>
                            <div class="col-md-3">
                                <small class="text-muted">Dernière Modification</small>
                                <div class="info-badge">{{ $abonne->updated_at->format('d/m/Y H:i') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('abonnes.update', $abonne->id) }}" method="POST" id="abonneForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                           ...
                                           id="num_cin"
                                           name="num_cin"
                                           value="{{ old('num_cin', $abonne->num_cin) }}"
                                           required>
                                    @error('num_cin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date"
                                           ...
                                           value="{{ old('date_abonnement', $abonne->date_abonnement->format('Y-m-d')) }}"
                                           required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                           ...
                                           id="reference"
                                           name="reference"
                                           value="{{ old('reference', $abonne->reference) }}"
                                           required>
                                    @error('reference')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Référence unique de l'abonné dans le système STEG</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('num_compteur_elec', $abonne->num_compteur_elec) }}"
                                           required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('num_compteur_gaz', $abonne->num_compteur_gaz) }}"
                                           required>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('adresse') is-invalid @enderror"
                                              ...
                                              name="adresse"
                                              rows="3"
                                              required>{{ old('adresse', $abonne->adresse) }}</textarea>
                                    @error('adresse')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <script>
        ...
        document.getElementById('abonneForm').addEventListener('submit', function(e) {
            if (!confirm('Êtes-vous sûr de vouloir modifier les informations de cet abonné ?')) {
                e.preventDefault();
            }
        });
    </script>
